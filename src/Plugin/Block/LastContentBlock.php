 ...
 *
 * @Block(
 *   id = "denistest_last_content",
 *   category = @Translation("denistest"),
 *   deriver = "Drupal\denistest\Plugin\Derivative\LastContentBlockDeriver",
 * )
 */
...
$node_type = $this->getDerivativeId();
    ...
    $modifier_class = \Drupal\Component\Utility\Html::getClass('last-content-list--' . str_replace('_', '-', $node_type));
    $build['content'] = [
      '#type' => 'html_tag',
      '#tag' => 'ul',
      '#attributes' => [
